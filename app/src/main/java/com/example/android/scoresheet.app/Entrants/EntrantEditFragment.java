...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDescrEditText.setText(ScoreSheetContract.EntrantEntry.getEntrantDescriptionFromUri(mUri));
        ...
        View.OnClickListener edit_saveOnClickListener = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if ( !(DescrEditText.equals("")) ) {
                    editUri = ScoreSheetContract.EntrantEntry.buildEntrantDesc(DescrEditText);
                    ContentValues mEditContentValues = new ContentValues();
                    mEditContentValues.put(ScoreSheetContract.EntrantEntry.COLUMN_TEAM_DESC, DescrEditText);
